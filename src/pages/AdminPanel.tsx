          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-slate-900 text-white rounded-2xl p-6 space-y-3 shadow-lg">
              ...
              <div className="space-y-2 text-xs leading-relaxed text-slate-300">
                ...
                <div className="flex justify-between bg-white/5 rounded-lg px-3 py-2"><span>→ Your commission (5%)</span><strong className="text-emerald-400">৳50 auto-credited</strong></div>
                <div className="flex justify-between bg-white/5 rounded-lg px-3 py-2"><span>→ Vendor receives (95%)</span><strong>৳950 to their wallet</strong></div>
          ...
          {orders.map((order) => (
            <div key={order.id} className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm flex flex-wrap items-center gap-4 text-xs">
              ...
              <div className="min-w-[120px]">
                <p className="font-bold capitalize text-slate-700">{order.payment_method} · {order.payment_status}</p>
              ...
              <div className="min-w-[110px]">
                ...
                <p className="text-[10px] text-purple-700 font-bold">Your profit: ৳{(platformAdminEarnings > 0 ? order.platform_fee_total : 0).toFixed(0)}+flagship</p>
              </div>
